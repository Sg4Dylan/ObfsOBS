...
function script_description()
    return "A filter that randomly rearranges equal-sized rectangular segments of an image in Y-axis."
end
...
source_info.create = function(settings, source)
    ...
    local effect_file_path = script_path() .. 'img-obfs-y.effect.hlsl'
