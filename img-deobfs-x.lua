...
function script_description()
    return "A filter that reconstructs an image from randomly shuffled in X-axis, equal-sized rectangular segments."
end
...
source_info.create = function(settings, source)
    ...
    local effect_file_path = script_path() .. 'img-deobfs-x.effect.hlsl'
